    ...
    pub fn travel_menu() -> Self {
        Self {
            ...
            items: vec![
                ...
                MenuItem { label: "牺牲之路".into(), action: MenuAction::Travel },
                MenuItem { label: "法兰要塞".into(), action: MenuAction::Travel },
                MenuItem { label: "幽邃教堂".into(), action: MenuAction::Travel },
                MenuItem { label: "卡萨斯的地下墓地".into(), action: MenuAction::Travel },
                MenuItem { label: "熏烟湖".into(), action: MenuAction::Travel },
                MenuItem { label: "冷冽谷的伊鲁席尔".into(), action: MenuAction::Travel },
                MenuItem { label: "伊鲁席尔地下牢".into(), action: MenuAction::Travel },
                MenuItem { label: "罪业之都".into(), action: MenuAction::Travel },
                MenuItem { label: "亚诺尔隆德".into(), action: MenuAction::Travel },
                MenuItem { label: "洛斯里克城".into(), action: MenuAction::Travel },
                MenuItem { label: "大书库".into(), action: MenuAction::Travel },
                MenuItem { label: "初始之火的火炉".into(), action: MenuAction::Travel },
                MenuItem { label: "妖王庭园".into(), action: MenuAction::Travel },
                MenuItem { label: "无主墓地".into(), action: MenuAction::Travel },
                MenuItem { label: "古龙顶".into(), action: MenuAction::Travel },
